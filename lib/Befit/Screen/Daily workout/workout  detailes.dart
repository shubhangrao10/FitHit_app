            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Image.asset("asset/gifs/pushups.gif",height:200,),
                ),
                SizedBox(height:10),
                RichText(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Padding(
                  padding: const EdgeInsets.all(20),
                  child: Image.asset("asset/gifs/crunches.gif",height:200,),
                ),
                SizedBox(height:10),
          RichText(
            textAlign: TextAlign.center,
          ...
          child: SingleChildScrollView(
            child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(20),
                    child: Image.asset("asset/gifs/plank.png",height:160,),
                  ),
                  SizedBox(height:10),
                  RichText(
                    textAlign: TextAlign.center,
          ...
          child: SingleChildScrollView(
            child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(20),
                    child: Image.asset("asset/gifs/climber.gif",height:160,),
                  ),
                  SizedBox(height:10),
                  RichText(
                    textAlign: TextAlign.center,
          ...
          child: SingleChildScrollView(
            child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(20),
                    child: Image.asset("asset/gifs/squats.gif",height:160,),
                  ),
                  SizedBox(height:10),
                  RichText(
                    textAlign: TextAlign.center,
          ...
          child: SingleChildScrollView(
            child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(20),
                    child: Image.asset("asset/gifs/slideplank.gif",),
                  ),
                  SizedBox(height:10),
                  RichText(
                    textAlign: TextAlign.center,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                Padding(
                  padding: const EdgeInsets.all(20),
                  child: Image.asset("asset/gifs/situp.gif",height: 250,),
                ),
                SizedBox(height:10),
                RichText(
                  textAlign: TextAlign.center,
